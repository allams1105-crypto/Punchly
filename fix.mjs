...
// Fix HeroGeometric — simple, clean, no subtitle
...
// Fix landing page — pass locale to HeroGeometric, fix ES button
writeFileSync("src/app/[locale]/page.tsx", `import Link from "next/link";
