...
const links = [
  { href: "/en/admin/dashboard", label: "Dashboard", icon: (
  ...
  { href: "/en/admin/payroll", label: "Nomina", icon: (
  ...
  { href: "/en/admin/employees/new", label: "Nuevo Empleado", icon: (
    <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/></svg>
  )},
  { href: "/en/admin/kiosk", label: "Kiosk", icon: (
    <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><rect x="5" y="2" width="14" height="20" rx="2"/><line x1="12" y1="18" x2="12" y2="18"/></svg>
  )},
