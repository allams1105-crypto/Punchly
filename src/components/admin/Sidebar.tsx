...
const links = [
  ...
  { href:"/en/admin/geofencing", label:"Ubicación", icon:"M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" },
...
export default function Sidebar({ orgName }: { orgName?: string }) {
  ...
  return (
    <div className="punchly-sidebar" style={{width:"220px",minHeight:"100vh",background:"rgba(255,255,255,0.01)",backdropFilter:"blur(30px)",WebkitBackdropFilter:"blur(30px)",borderRight:"1px solid rgba(255,255,255,0.06)",display:"flex",flexDirection:"column",flexShrink:0}}>
      {/* Logo */}
      <div style={{padding:"20px 16px 16px",borderBottom:"1px solid rgba(255,255,255,0.06)"}}>
        <div style={{display:"flex",alignItems:"center",gap:"10px",marginBottom:"4px"}}>
          <div style={{width:"32px",height:"32px",borderRadius:"10px",background:`linear-gradient(135deg, ${primary}, var(--accent-dark))`,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0, boxShadow: `0 0 15px ${primary}33`}}>
            <span style={{color:"#000",fontWeight:900,fontSize:"14px",fontFamily:"var(--font-inter)"}}>P</span>
          </div>
          <span style={{fontFamily:"var(--font-inter)",fontWeight:700,fontSize:"14px",color:"#FAFAFA"}}>Punchly.Clock</span>
        </div>
        {orgName && <p style={{fontFamily:"var(--font-inter)",fontSize:"11px",color:"rgba(255,255,255,0.25)",paddingLeft:"42px"}}>{orgName}</p>}
      </div>

      {/* Nav */}
      <nav style={{flex:1,padding:"12px 8px",overflowY:"auto"}}>
        <p style={{fontFamily:"var(--font-inter)",fontSize:"10px",fontWeight:600,color:"rgba(255,255,255,0.15)",textTransform:"uppercase",letterSpacing:"1.5px",padding:"4px 8px 8px"}}>Menu</p>
        {links.map(l=>{
      ...
      <div style={{padding:"12px 8px 16px",borderTop:"1px solid rgba(255,255,255,0.06)", display:"flex", flexDirection:"column", gap:"8px"}}>
        ...
        <button 
          ...
          style={{display:"flex",alignItems:"center",gap:"10px",padding:"9px 10px",borderRadius:"12px",width:"100%",border:"none",background:"transparent",color:"rgba(255,255,255,0.3)",fontSize:"13px",fontFamily:"var(--font-inter)",cursor:"pointer",transition:"all 0.15s"}}>
