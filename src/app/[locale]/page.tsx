...
export default function LandingPage() {
  return (
    <>
      ...
      <div style={{minHeight:"100vh",background:"#0A0A0A",color:"white",overflow:"hidden",fontFamily:"var(--font-dm-sans)",position:"relative"}}>
        
        {/* Fondo de Humo WebGL */}
        <div style={{position:"fixed",inset:0,zIndex:0,opacity:0.35}}>
          <SmokeBackground smokeColor="#C9A84C" />
        </div>

        {/* Dark overlay para asegurar que el texto se lea bien sobre el humo */}
        <div style={{position:"fixed",inset:0,zIndex:1,background:"linear-gradient(to bottom, rgba(10,10,10,0.5) 0%, rgba(10,10,10,0.7) 100%)", pointerEvents: "none"}} />

        {/* Orbes y Grid originales (los subimos a zIndex 2 para que estén sobre el humo) */}
        <div className="orb" style={{width:"500px",height:"500px",background:"rgba(201,168,76,0.07)",top:"-100px",left:"20%", zIndex:2}} />
        <div className="orb" style={{width:"300px",height:"300px",background:"rgba(255,255,255,0.03)",bottom:"20%",right:"10%",animationDelay:"3s", zIndex:2}} />
        <div className="grid-bg" style={{position:"fixed",inset:0,pointerEvents:"none", zIndex:2}} />

        {/* Contenido Principal */}
        <div style={{position:"relative", zIndex:10}}>
          {/* Nav */}
          <nav style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"24px 40px",maxWidth:"1200px",margin:"0 auto"}}>
          ...
          {/* Pricing */}
          <section style={{maxWidth:"420px",margin:"0 auto",padding:"0 40px 80px",textAlign:"center"}}>
