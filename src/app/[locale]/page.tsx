  ...
  return (
    <>
      <style>{`
        ...
        .glow-gold{box-shadow:0 0 80px rgba(201,168,76,0.2),0 0 160px rgba(201,168,76,0.06)}
        ...
        .lang-btn{font-size:11px;color:rgba(255,255,255,0.3);text-decoration:none;padding:4px 10px;border-radius:8px;transition:all 0.2s;font-family:var(--font-dm-sans)}
        .lang-btn:hover{color:white;background:rgba(255,255,255,0.06)}
        .lang-btn.active{color:#C9A84C;font-weight:700}
        @media(max-width:768px){.hide-sm{display:none!important}.grid-sm-1{grid-template-columns:1fr!important}.grid-sm-2{grid-template-columns:1fr 1fr!important}.px-sm{padding-left:20px!important;padding-right:20px!important}}
      `}</style>
      ...
      <div style={{minHeight:"100vh",color:"white",overflow:"hidden",fontFamily:"var(--font-dm-sans)",
        ...
        <nav style={{position:"absolute",top:0,left:0,right:0,zIndex:50,display:"flex",alignItems:"center",justifyContent:"space-between",padding:"24px 48px",maxWidth:"1280px",margin:"0 auto"}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:"10px"}}>
            <a href="/en/login" className="lang-btn active">EN</a>
            <span style={{color:"rgba(255,255,255,0.1)"}}>·</span>
            <a href="/es/login" className="lang-btn">ES</a>
            <span style={{width:"1px",height:"16px",background:"rgba(255,255,255,0.1)",margin:"0 6px"}} />
            <Link href="/en/login" style={{fontSize:"13px",color:"rgba(255,255,255,0.45)",textDecoration:"none",fontWeight:500}}>Sign in</Link>
            <Link href="/en/register" className="glass-gold btn-gold" style={{padding:"9px 22px",borderRadius:"12px",fontSize:"13px",fontFamily:"var(--font-syne)"}}>Get started</Link>
          </div>
        </nav>
        ...
        {/* FLOATING KIOSK — smaller, more padding from text */}
        <section style={{position:"relative",zIndex:10,padding:"20px 40px 80px",
          background:"linear-gradient(to bottom,transparent,#060810 50%)"}}>
                ...
                <div style={{padding:"14px 18px",display:"grid",gridTemplateColumns:"repeat(6,1fr)",gap:"8px"}}>
                  {[["A","Ana G.","#FFD166",true],["L","Luis M.","#60A5FA",true],["S","Sofia R.","#34D399",true],["C","Carlos P.","#F87171",false],["M","María J.","#A78BFA",false],["P","Pedro L.","#FB923C",false]].map(([i,n,c,a])=>(
                    <div key={String(n)} className="card-3d" style={{background:a?"rgba(52,211,153,0.05)":"rgba(255,255,255,0.03)",border:a?"1px solid rgba(52,211,153,0.12)":"1px solid rgba(255,255,255,0.05)",borderRadius:"12px",padding:"12px 8px",cursor:"pointer",textAlign:"center"}}>
                      <div style={{width:"28px",height:"28px",borderRadius:"8px",background:String(c)+"18",border:"1px solid "+String(c)+"25",display:"flex",alignItems:"center",justifyContent:"center",color:String(c),fontFamily:"var(--font-syne)",fontWeight:800,fontSize:"11px",margin:"0 auto 6px",boxShadow:"0 0 10px "+String(c)+"20"}}>
                        {i}
                      </div>
                      ...
                      {a
                        ? <div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:"3px",marginTop:"4px"}}>
                            <div className="pulse-dot" style={{width:"3px",height:"3px",background:"#34D399",borderRadius:"50%"}} />
                            <span style={{color:"#34D399",fontSize:"8px"}}>Active</span>
                          </div>
          ...
          <div className="fade-up-1" style={{maxWidth:"700px",margin:"28px auto 0",display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:"10px"}} >
            {[
              {value:"2,847",label:"Clock-ins processed",color:"#FFD166",glow:"rgba(201,168,76,0.12)"},
              {value:"99.9%",label:"Uptime guaranteed",color:"#34D399",glow:"rgba(52,211,153,0.08)"},
              {value:"< 1s",label:"Response time",color:"#60A5FA",glow:"rgba(96,165,250,0.08)"},
              {value:"$49",label:"One-time forever",color:"#FFD166",glow:"rgba(201,168,76,0.12)"},
            ].map(s=>(
        ...
        <section style={{padding:"80px 40px",background:"linear-gradient(to bottom,#060810,#08091A)"}}>
          <div style={{maxWidth:"1100px",margin:"0 auto"}}>
            <div className="fade-up-2" style={{textAlign:"center",marginBottom:"56px"}}>
              <p style={{color:"rgba(201,168,76,0.7)",fontSize:"11px",fontWeight:700,letterSpacing:"3px",textTransform:"uppercase",fontFamily:"var(--font-dm-sans)",marginBottom:"12px"}}>Features</p>
              <h2 style={{fontFamily:"var(--font-syne)",fontSize:"clamp(28px,4vw,44px)",fontWeight:800,marginBottom:"12px"}}>Everything you need</h2>
              <p style={{color:"rgba(255,255,255,0.25)",fontSize:"14px",maxWidth:"400px",margin:"0 auto",fontFamily:"var(--font-dm-sans)"}}>No subscriptions. No limits. One payment.</p>
            </div>
            <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"16px"}} className="grid-sm-1">
              {[
                {title:"PIN Kiosk",desc:"Tablet at the entrance. Each employee has their own 4-digit PIN. No buddy punching.",icon:"M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z",color:"#FFD166",glow:"rgba(201,168,76,0.08)"},
                {title:"Mobile Geofencing",desc:"Employees can only clock in from their phone if they're within the configured radius.",icon:"M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z",color:"#60A5FA",glow:"rgba(96,165,250,0.08)"},
                {title:"Live Alerts",desc:"Automatic email to admin when someone is late. No extra setup needed.",icon:"M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9",color:"#F87171",glow:"rgba(248,113,113,0.08)"},
                {title:"Auto Payroll",desc:"Bi-weekly calculation with regular and overtime hours. Export to CSV in one click.",icon:"M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z",color:"#34D399",glow:"rgba(52,211,153,0.08)"},
                {title:"Multi-tenant",desc:"Each client has their own isolated space with their employees and configuration.",icon:"M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4",color:"#A78BFA",glow:"rgba(167,139,250,0.08)"},
                {title:"One-time $49",desc:"No subscriptions. No surprises. Pay once and use Punchly.Clock forever.",icon:"M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z",color:"#FFD166",glow:"rgba(201,168,76,0.08)"},
              ].map(f=>(
                <div key={f.title} className="feature-card" style={{borderRadius:"20px",padding:"28px",boxShadow:"inset 0 1px 0 rgba(255,255,255,0.05)"}}>
                  <div style={{width:"44px",height:"44px",borderRadius:"13px",background:f.glow,border:"1px solid "+f.color+"22",display:"flex",alignItems:"center",justifyContent:"center",marginBottom:"18px",boxShadow:"0 0 20px "+f.glow}}>
        ...
        <section style={{padding:"80px 40px",background:"linear-gradient(to bottom,#08091A,#060810)"}}>
          <div style={{maxWidth:"960px",margin:"0 auto"}}>
            <div style={{textAlign:"center",marginBottom:"56px"}}>
              <p style={{color:"rgba(96,165,250,0.7)",fontSize:"11px",fontWeight:700,letterSpacing:"3px",textTransform:"uppercase",fontFamily:"var(--font-dm-sans)",marginBottom:"12px"}}>Process</p>
              <h2 style={{fontFamily:"var(--font-syne)",fontSize:"clamp(28px,4vw,44px)",fontWeight:800}}>Up and running in 3 minutes</h2>
            </div>
            <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"20px"}} className="grid-sm-1">
              {[
                {step:"01",title:"Create your account",desc:"Sign up free. Full 7-day trial, no credit card needed.",color:"#FFD166"},
                {step:"02",title:"Add employees",desc:"Create profiles, assign PINs and set work schedules.",color:"#60A5FA"},
                {step:"03",title:"Open the kiosk",desc:"Place a tablet at the entrance. Employees clock in with their PIN.",color:"#34D399"},
              ].map(s=>(
                <div key={s.step} className="step-card" style={{borderRadius:"20px",padding:"32px",boxShadow:"inset 0 1px 0 rgba(255,255,255,0.05)"}}>
                  <div style={{fontFamily:"var(--font-syne)",fontWeight:800,fontSize:"52px",lineHeight:1,marginBottom:"16px",
                    background:"linear-gradient(135deg,"+s.color+","+s.color+"30)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>
                    {s.step}
                  </div>
        ...
        <section style={{padding:"80px 40px 100px",background:"linear-gradient(to bottom,#060810,#030508)"}}>
          <div style={{maxWidth:"500px",margin:"0 auto",textAlign:"center"}}>
            <div className="fade-up-3">
              <p style={{color:"rgba(201,168,76,0.7)",fontSize:"11px",fontWeight:700,letterSpacing:"3px",textTransform:"uppercase",fontFamily:"var(--font-dm-sans)",marginBottom:"12px"}}>Pricing</p>
              <h2 style={{fontFamily:"var(--font-syne)",fontSize:"clamp(28px,4vw,44px)",fontWeight:800,marginBottom:"40px"}}>No surprises</h2>
              <div style={{borderRadius:"28px",padding:"3px",background:"linear-gradient(135deg,rgba(201,168,76,0.4),rgba(96,165,250,0.2),rgba(139,92,246,0.2))",boxShadow:"0 60px 100px rgba(0,0,0,0.6),0 0 80px rgba(201,168,76,0.1)"}}>
                <div style={{background:"linear-gradient(145deg,#0D0F1A,#080A12)",borderRadius:"25px",padding:"40px"}}>
                  <p style={{color:"rgba(255,255,255,0.2)",fontSize:"11px",letterSpacing:"3px",textTransform:"uppercase",marginBottom:"12px",fontFamily:"var(--font-syne)"}}>One-time payment</p>
                  <div style={{display:"flex",alignItems:"flex-end",justifyContent:"center",gap:"8px",marginBottom:"8px"}}>
                    ...
                    <span style={{color:"rgba(255,255,255,0.2)",marginBottom:"14px",fontSize:"14px",fontFamily:"var(--font-dm-sans)"}}>forever</span>
                  </div>
                  <p style={{color:"rgba(255,255,255,0.2)",fontSize:"12px",marginBottom:"28px",fontFamily:"var(--font-dm-sans)"}}>One payment. Permanent access.</p>
                  <ul style={{listStyle:"none",padding:0,marginBottom:"28px",textAlign:"left"}}>
                    {[
                      ["Unlimited employees","#FFD166"],
                      ["PIN kiosk per employee","#60A5FA"],
                      ["Mobile geofencing","#34D399"],
                      ["Late arrival email alerts","#F87171"],
                      ["Automatic bi-weekly payroll","#A78BFA"],
                      ["Support included","#FB923C"],
                    ].map(([f,c])=>(
                  ...
                  <Link href="/en/register" className="btn-gold" style={{display:"block",padding:"17px",borderRadius:"16px",fontFamily:"var(--font-syne)",fontSize:"15px",textDecoration:"none",textAlign:"center",boxShadow:"0 0 50px rgba(201,168,76,0.3)"}}>
                    Start 7-day free trial
                  </Link>
                  <p style={{color:"rgba(255,255,255,0.12)",fontSize:"11px",marginTop:"14px",fontFamily:"var(--font-dm-sans)"}}>Full access during trial · Cancel anytime</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <footer style={{background:"#030508",borderTop:"1px solid rgba(255,255,255,0.04)",padding:"32px 48px",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:"12px"}}>
          ...
          <div style={{display:"flex",gap:"20px"}}>
            ...
            <Link href="/en/register" style={{color:"rgba(201,168,76,0.5)",fontSize:"12px",textDecoration:"none",fontFamily:"var(--font-dm-sans)"}}>Register</Link>
          </div>
        </footer>
      </div>
    </>
